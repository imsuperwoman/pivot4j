...
public class PivotExportHandler {
	...
	public void exportChart() throws IOException, IllegalAccessException {
		
		FacesContext.getCurrentInstance().getExternalContext().redirect( "http://www.google.com?testing");
	}
	
	public void exportPdf() throws IOException, IllegalAccessException {
		FacesContext.getCurrentInstance().getExternalContext().redirect( "https://www.google.com?testing");
		return;/*
		TableRenderer renderer = viewHandler.getRenderer();
