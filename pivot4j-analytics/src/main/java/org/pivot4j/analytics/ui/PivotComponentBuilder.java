		...
		if (expressionFactory != null) {
			for (UICommand<?> command : commands) {
				...
				if (mode == null) {
					...
					System.out.println("$$$ PivotComponent icon : " + command.getName());
				} else {
					icon = iconMap.get(command.getName() + "-" + mode);
					System.out.println("$$$ PivotComponent icon : " + command.getName()  + " : " + mode);
				}
				...
				System.out.println("$$$ PivotComponent parameters.getAxisOrdinal() : " +  parameters.getAxisOrdinal());
				...
				System.out.println("$$$ PivotComponent parameters.getPositionOrdinal() : " +  parameters.getPositionOrdinal());
				...
				System.out.println("$$$ PivotComponent parameters.getMemberOrdinal() : " +  parameters.getMemberOrdinal());
				...
				System.out.println("$$$ PivotComponent parameters.getHierarchyOrdinal() : " +  parameters.getHierarchyOrdinal());
				...
				System.out.println("$$$ PivotComponent parameters.getCellOrdinal() : " +  parameters.getCellOrdinal());
		...
		for (String category : context.getRenderProperties().keySet()) {
			...
			for (String property : errors.keySet()) {
				...
				if (logger.isWarnEnabled()) {
					logger.warn( "$$PivotComp endRender : " + title, e);
				}
			}
		}
